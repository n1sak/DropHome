...
export const SEEDS: Seed[] = [
  ...
  { name: 'Passport scan.pdf', to: ['bedroom', 'bedroom-safe'], days: 400, touched: 60, tags: ['important'], pdf: ['Sample document', 'This stands in for a scan of a passport photo page.', 'Roomy keeps documents like this in the bedroom safe.'] },
